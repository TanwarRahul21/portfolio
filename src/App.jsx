    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-x-hidden">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s text-center md:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 break-words">
              <ShinyText text="Hi I'm Rahul Tanwar" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              ...
              animateBy="words"
              direction="top"
              className="text-sm sm:text-base md:text-lg mb-6 break-words"
            />
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center sm:gap-4 gap-3 w-full">
              <a 
                ...
                className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors w-full sm:w-auto text-center"
              >
                <ShinyText text="Download CV" disabled={false} speed={3} className="custom-class" />
              </a>

              <a href="#project" className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors w-full sm:w-auto text-center">
                <ShinyText text="Explore My Projects" disabled={false} speed={3} className="custom-class" />
              </a>
            </div>

          </div>
          <div className="flex justify-center md:justify-end animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
        ...
        <div className="tools mt-32">
          <h1 className="text-3xl sm:text-4xl/snug font-bold mb-4" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" >Tools & Technologies</h1>
          <p className="w-full sm:w-3/5 md:w-2/5 text-base/loose opacity-50 break-words" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">My Profesional Skills</p>
          <div className="tools-box mt-14 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <h1 className="text-center text-3xl sm:text-4xl font-bold mb-2" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">Project</h1>
        <p className="text-base/loose text-center opacity-50 break-words" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Showcasing a selection of projects that reflect my skills, creativity, and passion for building meaningful digital experiences.</p>
